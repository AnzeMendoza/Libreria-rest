...
SALIR:BEGIN
    ...
    START TRANSACTION;
        ...
        INSERT INTO cliente (id, documento, nombre, apellido, telefono, alta, username, user_password,rol_id)
        VALUES(pIdCliente, pDocumento, pNombre, pApellido, pTelefono, 1, pUsername, pUserPassword,pRolId);
...
-- Dump completed on 2022-01-05 13:44:33
